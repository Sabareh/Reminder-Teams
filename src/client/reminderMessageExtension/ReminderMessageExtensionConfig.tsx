...
/**
 * Implementation of the Reminder Message Extension configuration page
 */
export const ReminderMessageExtensionConfig = () => {
    ...
    return (
        <Provider theme={theme} styles={{ height: "100vh", width: "100vw", padding: "1em" }}>
            <Flex fill={true}>
                <Flex.Item>
                    <div>
                        <Header content="Reminder Message Extension configuration" />
                        <Checkbox
                            label="On or off?"
                            toggle
                            checked={onOrOff}
